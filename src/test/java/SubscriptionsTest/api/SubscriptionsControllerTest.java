...
public class SubscriptionsControllerTest {
    ...
    @Mock
    private SubscriptionsViewMapper subscriptionsViewMapper;    @Mock
    ...
    void testCancelSubscription_ValidIfMatch_ShouldReturnCancelledSubscription() {
        ...
        ResponseEntity<SubscriptionsView> result = subscriptionsController.cancelSubscription(servletWebRequest);
